    ...
    <div className='screen-max-width'>
        ...
        <div className='flex flex-col items-center mt-5'>
            ...
            <div className='flex-center'>
                <ul className='color-container mt-6'>
                     {models.map((items,i)=>(
                        <li key={i} className='w-6 h-6 rounded-full mx-2 cursor-pointer ' style={{backgroundColor:items.color[0]}} onClick={()=> setModel(items)} >
                        </li>
                     ))}
                </ul>
